...
class ClosureSearchableGrailsDomainClassCompassClassMapper extends AbstractSearchableGrailsDomainClassCompassClassMapper {
    ...
    static
    final SEARCHABLE_PROPERTY_OPTIONS = ['accessor', 'analyzer', 'boost', 'converter', 'excludeFromAll', 'format', 'index', 'managedId', 'managedIdIndex', 'name', 'nullValue', 'propertyConverter', 'reverse', 'store', 'spellCheck', 'termVector']
    static
    final SEARCHABLE_CONSTANT_OPTIONS = ['analyzer', 'boost', 'excludeFromAll', 'index', 'spellCheck', 'store', 'termVector', 'converter']
    static
    final SEARCHABLE_REFERENCE_OPTIONS = ['accessor', 'cascade', 'converter', 'lazy', 'refAlias', 'refComponentAlias']
    static
    final SEARCHABLE_COMPONENT_OPTIONS = ['accessor', 'cascade', 'converter', 'maxDepth', 'override', 'prefix', 'refAlias']
    ...
    static
    final CLASS_MAPPING_OPTIONS = ['all', 'allName', 'allAnalyzer', 'allTermVector', 'alias', 'analyzer', 'boost', 'converter', 'enableAll', 'managedId', 'root', 'spellCheck', 'subIndex', 'supportUnmarshall']
    ...
    private List searchableGetCompassClassPropertyMappings(GrailsDomainClass grailsDomainClass, Collection searchableGrailsDomainClasses, Closure closure, List excludedProperties, List inheritedPropertyMappings) {
        ...
        for (property in mappableProperties) {
            if (!mappedProperties.any { it.propertyName == property.name }) {
                mappedProperties << Object.getDefaultPropertyMapping(property, searchableGrailsDomainClasses)
            }
        }
        return mappedProperties
    }
    ...
    Object invokeMethod(String name, Object args) {
        ...
        // Get default mapping
        def defaultMapping = Object.getDefaultPropertyMapping(property, searchableGrailsDomainClasses)
